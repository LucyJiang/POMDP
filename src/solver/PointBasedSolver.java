...
public class PointBasedSolver extends ValueIterationSolver {
	...
	protected void expand() {
		...
		while (fullBset.size() < params.getMaxTotalPoints()
			...
			if(testBset.size() == 0){
				if (params.getExpandMethod()== PointBasedSolverParam.EXPAND_RANDOM_EXPLORE)
